...
/*
 * font8x8.h — Minimal 8x8 bitmap font covering ASCII 0x20–0x7E.
 *
 * Each character is 8 bytes, one byte per row, MSB = leftmost pixel.
 * Index into the array as:  font8x8_basic[ch - 0x20]
 *
 * This is the well-known "font8x8_basic" public-domain bitmap font
 * used in countless embedded/retro projects.
 */
