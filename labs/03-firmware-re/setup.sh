#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────
# Lab: Firmware Reverse Engineering — XOR flag extraction
#
...
#   3. Installs esptool if not already present
# ─────────────────────────────────────────────────────────────────────
set -euo pipefail
...
LAB_ID="${LAB_NAME:-03-firmware-re}"
...
# ── Ensure esptool is available for participants ───────────────────
...
# ── Done ───────────────────────────────────────────────────────────
echo ""
info "\"Firmware Reverse Engineering\" lab ready!"
echo "  Firmware:   $LAB_DIR/labs/$LAB_ID"
echo "  Workflow:   Flash device, participant dumps with esptool, RE the XOR flag"
